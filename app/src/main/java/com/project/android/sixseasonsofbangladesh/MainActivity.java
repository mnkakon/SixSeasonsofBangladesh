...
public class MainActivity extends AppCompatActivity {
    ...
    public void rainyClick(View view){
        Intent i = new Intent(getApplicationContext(), Rainy.class);
        startActivity(i);
    }

    public void autumnClick(View view){
        Intent i = new Intent(getApplicationContext(), Autumn.class);
        startActivity(i);
    }

    public void dryseasonClick(View view){
        Intent i = new Intent(getApplicationContext(), Dryseason.class);
        startActivity(i);
    }
    ...
    public void springClick(View view){
